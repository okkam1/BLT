<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FindClients.aspx.cs" Inherits="autoCompleteTest" Trace="false" EnableViewState="true" %>
...
<asp:CustomValidator ID="Validator" runat="server" ErrorMessage="* Required" ClientValidationFunction = "Validate" />
    ...
    <asp:GridView ID="gvClients" runat="server" AllowSorting="false" AllowPaging="true"
        AutoGenerateEditButton="false" DataKeyNames="PersonId"
        AutoGenerateColumns="false" AutoGenerateDeleteButton="false" AutoGenerateSelectButton="False" CssClass="DD" OnPageIndexChanging="gvClients_PageIndexChanging">
        <Columns>
