...
<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditFamily.aspx.cs" Inherits="EditFamily" Trace="false" EnableViewState="true"%>
...
ErrorMessage="Date must be today or a past date!"  Operator="LessThanEqual" Type="Date" ForeColor="Red">
            ...
            <tr><td>Is Home Owner Occupied?</td>
                <td>
                       ...
                       <asp:RadioButtonList ID="rblOwnerOccupied" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" Enabled="False">
