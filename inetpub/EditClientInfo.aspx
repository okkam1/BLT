    ...
    <div class="DD">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="FamilyNameList" runat="server" ViewStateMode="Enabled" OnSelectedIndexChanged="FamilyNameList_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
            ...
            <asp:Panel runat="server" ID="pnlFamilyMembers" Visible="false">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlFamilyMembers" runat="server" ViewStateMode="Enabled" AutoPostBack="True" OnSelectedIndexChanged="ddlFamilyMembers_SelectedIndexChanged"></asp:DropDownList>
            ...
            <tr>
                <td>First Name:</td>
                <td>
                    <asp:TextBox ID="tbFirstName" runat="server" Width="300px" ViewStateMode="Enabled"></asp:TextBox>
            ...
            <tr>
                <td>Last Name:</td>
                <td>
                    <asp:TextBox ID="tbLastName" runat="server" placeholder="Optional; if different than Family Last Name" Width="300px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td>Birth Date:
                    ...
                    <em>(MM/DD/YYYY)</em></td>
                <td>
                    <asp:TextBox ID="tbBirthDate" runat="server" placeholder="MM/dd/yyyy" ToolTip="Date the client was born"></asp:TextBox>
