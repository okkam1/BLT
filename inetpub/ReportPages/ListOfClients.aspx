<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ListOfClients.aspx.cs" Inherits="ReportPages_ListOfFamilies" %>
...
<asp:CompareValidator
    ...
    ErrorMessage="Please enter a valid date." ForeColor="Red">
        ...
        <asp:SqlDataSource ID="SqlDataSourcePerson" runat="server" ConnectionString="<%$ ConnectionStrings:csLCCHP%>" SelectCommand="SELECT * FROM [Person] where isClient=1 and ModifiedDate between (@StartDate) and (@EndDate)">
