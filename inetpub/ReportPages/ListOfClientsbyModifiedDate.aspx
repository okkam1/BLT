<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ListOfClientsbyModifiedDate.aspx.cs" Inherits="ReportPages_ListOfClientsByModifiedDate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="DD">
        ...
        <h2 class="DDSubHeader">List of Clients</h2>
    ...
    ErrorMessage="Please enter a valid date." ForeColor="Red">
        ...
        <p>&nbsp;</p>
            ...
            <LocalReport ReportPath="Reports\ListOfClientsDate.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDataSourcePerson" Name="ListClientsByModifiedDate" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>

        <asp:SqlDataSource ID="SqlDataSourcePerson" runat="server" ConnectionString="<%$ ConnectionStrings:csLCCHP%>" SelectCommand="usp_SlListClientsByModifieddate" SelectCommandType="StoredProcedure">
