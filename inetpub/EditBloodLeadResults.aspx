...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  FROM [dbo].[BloodTestResults] WHERE [PersonID] = @PersonID"
          ...
          UpdateCommand="UPDATE [BloodTestResults] SET [LeadValue] = @LeadValue, [SampleDate] = @SampleDate, [LabSubmissionDate] = @LabSubmissionDate, [HemoglobinValue] = @HemoglobinValue WHERE [BloodTestResultsID] = @BloodTestResultsID"
